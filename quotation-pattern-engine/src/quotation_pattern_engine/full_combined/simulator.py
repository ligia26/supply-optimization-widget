...
from quotation_pattern_engine.local_market.models import LocalDailySignal, CompetitorPrice
from quotation_pattern_engine.local_market.signal import build_local_market_signal, merge_macro_and_local
from quotation_pattern_engine.combined.models import CombinedPurchaseDecision
from quotation_pattern_engine.combined.optimizer import (
    evaluate_combined_candidates,
    select_combined_candidate,
)
from quotation_pattern_engine.combined.signal import combine_signals
...
def simulate_full_strategy(
    ...
    local_daily_signals: list[LocalDailySignal],
    competitor_history: list[CompetitorPrice],
    operational_config: OperationalConfig,
    external_config: ExternalConfig,
    combined_config: CombinedConfig,
    local_config: LocalMarketConfig,
) -> tuple[
    list[DailyLedgerRow],
    ...
    for day_index in range(
        ...
        for tank in sorted(
            ...
            if point is not None:
                ...
                macro_external_signal = build_external_signal(
                ...
                local_market_signal = build_local_market_signal(
                    local_daily_signals,
                    competitor_history,
                    tank.product,
                    day,
                ...
                external_signal = merge_macro_and_local(
                    macro_external_signal,
                    local_market_signal,
                    local_config,
                )
