...
class OperationalConfig:
    ...
    minimum_order_litres: float = 0.0
    ...
    def __post_init__(self) -> None:
        ...
        for name in ("minimum_order_litres", "order_cost_eur", "holding_cost_eur_per_litre_day", "working_capital_cost_rate_daily", "risk_aversion"):
    ...
    def from_json(cls, path: str | Path) -> "OperationalConfig":
        ...
        if "ignored_products" in payload: payload["ignored_products"]=tuple(payload["ignored_products"])
        # Backward compatibility: candidate_cover_days is intentionally ignored by v10.
